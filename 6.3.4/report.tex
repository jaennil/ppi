...
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{auto_diag1}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{auto_diag2}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{auto_diag3}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{auto_diag4}}
\end{minipage}
\bigskip
...
\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{drom_diag1}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{drom_diag2}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{drom_diag3}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{drom_diag4}}
\end{minipage}
\bigskip
...
\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{sberauto_diag1}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{sberauto_diag2}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{sberauto_diag3}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{sberauto_diag4}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{sberauto_diag5}}
\end{minipage}
\bigskip
...
\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{mobile_diag1}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{mobile_diag2}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{mobile_diag3}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{mobile_diag4}}
\end{minipage}
\bigskip
...
\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{autoscout24_diag1}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{autoscout24_diag2}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{autoscout24_diag3}}
\end{minipage}
\bigskip

\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{autoscout24_diag4}}
\end{minipage}
\bigskip

На сайте нет проблем с изображениями за исключением проблем с контрастностью.
\bigskip
...
\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{nature_tineye}}
...
\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{step_tineye}}
    \captionof{figure}{Анализ на уникальность через сервис tineye.com}
\end{minipage}
\bigskip
...
\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{figma2}}
...
\noindent
\begin{minipage}{\linewidth}
    \fbox{\includegraphics[width=\linewidth]{figma1}}
    \captionof{figure}{Макет}
\end{minipage}
\bigskip
